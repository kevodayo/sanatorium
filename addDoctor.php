...
{	
	...
	if(strlen($_POST['npass'])<6){
		//echo 'Your Password should be atleast 6 characters';
		echo "<script>alert('Your Password should be atleast 6 characters');</script>";
		...
		$sql = $db->insert('doctor',array('specialization'=>$docspecialization,
									  'doctorname'=>$docname,
									  'address'=>$docaddress,
									  'docfee'=>$docfees,
					...
					<div class="wrap-content container" id="container">
						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
								...
								<input type="text" name="Doctorspecialization" class="form-control"  placeholder="Enter Doctor Speciality">
